...
A_LONG_aug=[A(1,1)  A(1,3)  A(1,5)  A(1,8)  A(1,12)         % [u w q theta]_dot=A_LONG*[u w q theta]'
...
A_LATERAL_aug=[A(2,2) A(2,4) A(2,6) A(2,7)  A(2,9)  A(2,11) % [v p r phi psi y]_dot=A_LATERAL*[v p r phi]'
